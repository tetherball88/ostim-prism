(function() {
  ...
  function useTooltip() {
    const [tooltip, setTooltip] = reactExports.useState({ visible: false, x: 0, y: 0, text: "" });
    const tooltipOn = (text) => ({
      onMouseEnter: (e) => setTooltip({ visible: true, x: e.clientX, y: e.clientY, text }),
  ...
  const mockNavigationOptions = Array.from({ length: 20 }, (_, i) => ({
    id: (i + 1).toString(),
    iconPath: "",
  ...
  const createNavigationSlice = (set, get) => ({
    ...
    updateNavigationOptions: (options) => set((state) => ({
      navigation: { ...state.navigation, options: [...options], activeIndex: 0 }
    })),
    setNavigationActiveIndex: (index) => set((state) => ({
      navigation: { ...state.navigation, activeIndex: index }
    })),
    selectNavigationOption: (index) => {
      var _a;
      const state = get();
    ...
    moveNavigationFocus: (direction) => set((state) => {
  ...
  const createControlButtonsSlice = (set) => ({
    controlButtons: {
      buttons: [
    ...
    setButtonsActiveIndex: (index) => set((state) => ({
      controlButtons: { ...state.controlButtons, activeIndex: index }
    })),
    moveControlButtonsFocus: (direction) => set((state) => {
  ...
  const createSearchSlice = (set, get) => ({
    ...
    moveSearchFocus: (direction) => set((state) => {
  ...
  const createAlignmentSlice = (set) => ({
    alignment: {
      actorIndex: 0,
      actorCount: 0,
      sceneId: "",
    ...
    updateAlignment: (payload) => set((state) => {
      const nextInputValues = alignmentFields.map((f2) => {
        if (f2.key === "actor") {
          const count = Math.max(payload.actorCount, 1);
          const display = Math.min(payload.actorIndex + 1, count);
          return display.toString();
        }
        const val = payload.data[f2.key];
        return f2.precision !== void 0 ? val.toFixed(f2.precision) : val.toString();
      });
      return {
        alignment: {
          ...state.alignment,
    ...
    moveAlignmentField: (direction) => set((state) => {
  ...
  const createGlobalUISlice = (set, get) => ({
    ...
    navigatingAt: 0,
    gameReady: false,
    updateActiveMenu: (menu) => set((state) => {
      var _a, _b;
      ...
      if (menu === "alignMenu" || menu === "searchMenu") {
        (_b = window.sendAction) == null ? void 0 : _b.call(window, JSON.stringify({
          action: "focus",
    ...
    setFocusBlock: (block) => set(() => ({ focusBlock: block })),
    handleControlInput: (control) => {
      ...
      if (focusBlock === "buttons") {
        ...
        else if (lowerCaseControl === "yes") state.updateActiveMenu(((_a = state.controlButtons.buttons[state.controlButtons.activeIndex]) == null ? void 0 : _a.id) || "navigation");
        ...
        if (activeMenu === "alignMenu") {
          ...
          if (lowerCaseControl === "toggle") {
            ...
            const actorFieldIdx = alignmentFields.findIndex((f2) => f2.key === "actor");
            ...
            const field = ((_b = alignmentFields[activeFieldIdx]) == null ? void 0 : _b.key) ?? "actor";
  ...
  const createUtilityOptionsSlice = (set, get) => ({
    utilityOptions: {
      options: mockUtilityOptions,
      activeIndex: 0
    },
    updateUtilityOptions: (options) => set((state) => ({
      utilityOptions: { ...state.utilityOptions, options: [...options], activeIndex: 0 }
    })),
    setUtilityOptionsActiveIndex: (index) => set((state) => ({
      utilityOptions: { ...state.utilityOptions, activeIndex: index }
    })),
    selectUtilityOption: (index) => {
      var _a;
      const state = get();
  ...
  const createThreadStatusSlice = (set, get) => ({
    ...
    updateThreadStatus: (status) => set(() => ({ threadStatus: status })),
    setThreadSpeed: (speed) => {
      ...
      (_a = window.sendAction) == null ? void 0 : _a.call(window, JSON.stringify({ action: "setSpeed", payload: { speed: clamped } }));
    }
  });
  const createKeySlice = (set) => ({
    keys: {
      keyUp: 104,
      keyDown: 101,
      keyLeft: 100,
    ...
    updateKeys: (keys) => set({ keys })
  });
  const useOStimStore = create()(
    devtools((...a) => ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-label", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "progress-name", children: name }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { ...tooltip })
        ]
      }
    );
  };
  function ThreadStatus() {
    const { autoControl, manualControl, locked, currentSpeed, minSpeed, maxSpeed } = useOStimStore((state) => state.threadStatus);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { ...tooltipOn("Locked Control"), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "51", y: "18", width: "18", height: "17", rx: "2", fill: "transparent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "54", y: "24.5", width: "12", height: "8", rx: "1.5", fill: lockedColor })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { ...tooltipOn("Auto Control"), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "32", y: "82", width: "22", height: "18", rx: "2", fill: "transparent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "36,85 36,95 49,90", fill: autoColor })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { ...tooltipOn("Manual Control"), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "78", cy: "90", r: "11", fill: "transparent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "circle",
                {
                  cx: "78",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "78", cy: "90", r: "2.2", fill: manualColor })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "thread-label", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "thread-speed-range", children: hasRange ? `Min ${minSpeed} - Max ${maxSpeed}` : "" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { ...tooltip })
    ] });
  }
  const ProgressBarContainer = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "progress-bar-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginRight: "80px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThreadStatus, {}) }),
      actorsState.map((actor, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ProgressBar,
        {
          index
        },
  ...
  const Icon = ({ base64Data, path = "", size = "4em" }) => {
    const canvasRef = reactExports.useRef(null);
    const [imageSrc, setImageSrc] = reactExports.useState(null);
    reactExports.useEffect(() => {
      if (!base64Data) {
        setImageSrc(path || PLACEHOLDER_ICON);
        return;
      }
      const processDDS = (buffer2) => {
        try {
          ...
          if (fourCC === 827611204) {
            decodeDXT1(buffer2, dataOffset, headerWidth, headerHeight, imageData.data);
          } else if (fourCC === 894720068) {
            decodeDXT5(buffer2, dataOffset, headerWidth, headerHeight, imageData.data);
          } else {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      imageSrc && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: imageSrc, style: { width: size, height: size }, alt: "" })
    ] });
  };
  function decodeDXT1(buffer, offset, width, height, output) {
  ...
  function decodeDXT5(buffer, offset, width, height, output) {
    const data = new DataView(buffer);
    const blocksX = Math.ceil(width / 4);
    const blocksY = Math.ceil(height / 4);
    for (let by = 0; by < blocksY; by++) {
      for (let bx = 0; bx < blocksX; bx++) {
        ...
        const alphaBits = data.getUint8(blockOffset + 2) | data.getUint8(blockOffset + 3) << 8 | data.getUint8(blockOffset + 4) << 16 | data.getUint8(blockOffset + 5) << 24 | data.getUint8(blockOffset + 6) * 4294967296 | data.getUint8(blockOffset + 7) * 1099511627776;
        ...
        for (let py = 0; py < 4; py++) {
          for (let px = 0; px < 4; px++) {
            ...
            const alphaIdx = alphaBits / Math.pow(2, pixelIdx * 3) & 7;
            const color = colors[colorIdx];
  ...
  function decodeColors565(c0, c1, hasTransparent) {
  ...
  const List = ({ options, activeIndex, setListActiveIndex, selectOption }) => {
    ...
    const updateVisibleCount = reactExports.useCallback(() => {
    ...
    const getScrollPositions = () => {
      ...
      const selectorPosition2 = visualIndex - containerOffset + bottomOffset;
      return {
        containerTransform: (-containerOffset + bottomOffset) * itemHeight,
        selectorPosition: selectorPosition2 * itemHeight
      };
    };
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `list ${containerTransform === 0 ? "top" : ""} ${containerTransform === -(getItemHeight() * (options.length - visibleCount)) ? "bottom" : ""}`, ref: windowRef, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "list-container", role: "listbox", style: { transform: `translateY(${containerTransform}px)` }, children: reversedOptions.map((opt, visualIdx) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            opt.id + opt.description + opt.iconPath
          );
        }) })
      ] })
    ] });
  ...
  const SearchMenu = () => {
    ...
    reactExports.useEffect(() => {
      ...
      const numKeys = [keys.keyDown, keys.keyUp, keys.keyLeft, keys.keyRight, keys.keyYes];
      console.log("Current keys:", keys);
      const handleBeforeInput = (event) => {
        if (lastKey !== null && numKeys.some((k2) => k2 === lastKey)) {
    ...
    reactExports.useEffect(() => {
      return () => {
        ...
        (_a = window.sendAction) == null ? void 0 : _a.call(window, JSON.stringify({ action: "setTextInputFocus", payload: { focused: false } }));
      };
    }, []);
    reactExports.useEffect(() => {
    ...
    const handleInputFocus = () => {
      var _a;
      {
        (_a = window.sendAction) == null ? void 0 : _a.call(window, JSON.stringify({ action: "setTextInputFocus", payload: { focused: true } }));
      }
    };
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "search-title", children: "Scene Search" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "search-count", children: [
          results.length,
          " found"
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-results", role: "listbox", ref: listRef, children: [
        results.length === 0 && query.trim().length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "search-empty", children: "No matches." }),
        results.length === 0 && query.trim().length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "search-empty", children: "Start typing to search scenes." }),
        results.map((result, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "search-name", children: result.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "search-meta", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "search-scene", children: result.sceneId }) })
            ]
          },
          result.sceneId
        ))
  ...
  const AlignmentMenu = () => {
    ...
    useOStimStore((state) => state.updateAlignment);
    ...
    reactExports.useEffect(() => {
      ...
      const numKeys = Object.values(keys).map((k2) => k2);
      const handleBeforeInput = (event) => {
        if (lastKey !== null && numKeys.some((k2) => k2 === lastKey)) {
          event.preventDefault();
        }
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "align-panel", "aria-label": "Alignment menu", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "align-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "align-title", children: "Alignment" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "align-info-container", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "align-info-row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "align-info-label", children: "Scene:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "align-info-value", children: alignment.sceneName || alignment.sceneId }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "align-info-sub", children: [
              "(",
              alignment.sceneId,
              ")"
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "align-info-row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "align-info-label", children: "Actor:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "align-info-value", children: alignment.actorName }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "align-info-sub", children: [
              "(",
              alignment.actorGender,
              ")"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "align-info-index", children: [
              "[",
              alignment.actorIndex + 1,
              "/",
              Math.max(alignment.actorCount, 1),
              "]"
            ] })
          ] })
        ] })
      ] }, alignment.actorName + alignment.actorIndex),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "align-fields", role: "listbox", "aria-activedescendant": `align-field-${alignment.activeField}`, children: alignmentFields.map((field, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "align-label", children: field.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                ref: (node) => {
        ...
        field.key + alignment.actorIndex
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "align-hint", children: "Up/Down: Select • Left/Right: Adjust • Type: Set Value • Tab/Close: Close" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
  ...
  const ControlButtons = () => {
    ...
    const [indicatorStyle, setIndicatorStyle] = reactExports.useState({ opacity: 0 });
    const targetIndex = hoverIndex ?? activeIndex;
    reactExports.useLayoutEffect(() => {
      setTimeout(() => {
        const el2 = buttonRefs.current[targetIndex];
        if (!el2) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, className: `control-buttons ${focusBlock === "buttons" ? "focused" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "control-button-indicator", style: indicatorStyle }),
      controlButtons.map((button, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ref: (el2) => {
            buttonRefs.current[index] = el2;
          },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: "var(--control-buttons-size)", height: "var(--control-buttons-size)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { base64Data: button.iconData, path: button.iconPath, size: "var(--control-buttons-size)" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "control-button-label", children: button.description })
          ]
        },
        button.id
      ))
  ...
  function App() {
    ...
    useControls();
    const style = {};
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `ui-container ${focusBlock === "buttons" ? "focus-buttons" : "focus-menu"}`, style, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "buttons-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ControlButtons, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBarContainer, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "menu-section", children: [
        activeMenu === "navigation" && /* @__PURE__ */ jsxRuntimeExports.jsx(NavigationList, {}),
        activeMenu === "utilityOptions" && /* @__PURE__ */ jsxRuntimeExports.jsx(UtilityOptionsList, {}),
        activeMenu === "searchMenu" && /* @__PURE__ */ jsxRuntimeExports.jsx(SearchMenu, {}),
        activeMenu === "alignMenu" && /* @__PURE__ */ jsxRuntimeExports.jsx(AlignmentMenu, {})
      ] })
    ] });
  }
  const scanCodeToJS = {
    ...
    // Misc
    181: 111,
    // Numpad divide? (often mapped to / in games)
    55: 106,
    // Numpad Multiply (*) - DX 55 is typically * on numpad
    74: 109,
    // Numpad Subtract (-)
    78: 107
    // Numpad Add (+)
  };
  const convertScanCodeToJS = (scanCode) => {
  ...
  function setupGameIntegration(store2) {
    ...
    window.updateNavigation = (navigationOptions) => {
      console.log("updateNavigation called with:", navigationOptions);
      const options = typeof navigationOptions === "string" ? JSON.parse(navigationOptions) : navigationOptions;
      store2.updateNavigationOptions(options);
    };
    window.updateOptions = (utilityOptions) => {
      console.log("updateOptions called with:", utilityOptions);
      const options = typeof utilityOptions === "string" ? JSON.parse(utilityOptions) : utilityOptions;
      store2.updateUtilityOptions(options);
    };
    window.updateKeys = (keys) => {
      ...
      store2.updateKeys(convertedKeys);
    };
    window.updateSearchResults = (results) => {
      const parsed = typeof results === "string" ? JSON.parse(results) : results;
      store2.updateSearchResults(parsed);
    };
    window.updateAlignment = (payload) => {
      const parsed = typeof payload === "string" ? JSON.parse(payload) : payload;
      console.log("updateAlignment called with:", parsed);
      store2.updateAlignment(parsed);
    };
